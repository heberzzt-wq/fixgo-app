...
function renderizarTareas(tareas) {
    ...
    tareasOrdenadas.forEach(tarea => {
        ...
        div.className = `mb-1 px-2 py-1.5 rounded-lg w-full max-w-[720px] mx-auto border transition-all active:scale-95 flex justify-between items-center cursor-pointer ${borderClass}`;
