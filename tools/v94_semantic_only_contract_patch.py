...
# NEXO static contract: certify the semantic-only routing label instead of the
# retired natural-language local resilience route.
...
# Marketing tests: the semantic planner must provide factual identity. Missing
# nonfactual strategy fields are editable assumptions, not a reason to invoke a
# second local brain or interrogate the user.
