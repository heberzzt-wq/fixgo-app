/* =========================================================
   JARVIS MUTATION GATEWAY V8 FOUNDATION
   Canonical authorize -> simulate -> approve -> execute -> verify pipeline.
========================================================= */

const MUTATION_GATEWAY_VERSION = "8.0.0-foundation";
...
export function createJarvisMutationGateway({
    ...
    async function run(mutation = {}, context = {}) {
        ...
        try {
            ...
            trace.stages.push({ stage: "APPROVAL", ok: true, approved: context.approved === true || !requiresApproval });
