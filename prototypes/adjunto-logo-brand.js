(() => {
  ...
  function injectionCss() {
    return `
      ...
      .adjunto-erase{position:absolute;z-index:12;left:0;right:0;top:58.5%;bottom:5%;pointer-events:none;background:radial-gradient(ellipse at 50% 28%,rgba(0,24,59,.72) 0,rgba(0,5,18,.96) 34%,#000 72%);box-shadow:0 -24px 45px rgba(0,0,0,.72),0 24px 36px #000}
