...
test("V142 HuMo runtime certification CLI is single-purpose budgeted and cleanup-verified", () => {
    ...
    assert.equal(bridgeSource.includes('JARVIS_RUNPOD_PAID_RESOURCE_CREATION_AUTHORIZED: "true"'), true);
