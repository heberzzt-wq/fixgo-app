...
for (const marker of [NEW_HUMO_IMAGE,NEW_HUMO_DIGEST,'runtimePreflightCertified: false','physicalRuntimeCertified: false','physicalRuntimeCertification: null',"importlib.metadata.version('torch').startswith('2.5.1')",'bootstrapDiagnostics = state.phase === "BOOTSTRAPPING"','await captureBootstrapFailureDiagnostics(state)']) {
