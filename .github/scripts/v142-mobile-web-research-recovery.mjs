...
// V142 materialized architecture is the base. Never resurrect browser/public semantic brains.
...
// Exactly two semantic transports: Gemini Developer primary, Vertex ADC secondary.
...
// Remove every public/OpenAI-compatible semantic route from the existing planner.
...
// Gemini 3 request compatibility + semantic-empty failover in the existing two-provider chain.
...
// Remove obsolete public-provider tests generically; keep authenticated contracts.
