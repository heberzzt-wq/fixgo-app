...
test("terminal has natural patchPreview follow-up memory gate before core planner", () => {
    ...
    assert.match(terminal, /sia7-bounded-business-v3-20260715-missions-v32/);
...
test("brain delegates natural intent to the bounded semantic model planner", () => {
    ...
    assert.match(brain, /sia7-model-semantic-planner-v5-gemini-20260714/);
    assert.equal(
    ...
    assert.match(core, /brain\.engine\.js\?v=sia7-model-semantic-planner-v5-gemini-20260714/);
