...
test("terminal has natural patchPreview follow-up memory gate before core planner", () => {
    ...
    assert.match(terminal, /mixed-intent-v2-20260714-4260/);
    ...
    assert.match(terminal, /jarvis-tools-v7-20260713-supervision-v9-grounded-web-health/);
...
test("brain protects repo hub analysis from visual patch proposal drift", () => {
    ...
    assert.match(core, /jarvis-tools-v7-20260713-supervision-v9-grounded-web-health/);
