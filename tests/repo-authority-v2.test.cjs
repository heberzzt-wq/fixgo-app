...
test("brain delegates natural intent to the bounded semantic model planner", () => {
    ...
    assert.match(brain, /sia7-multimodal-batch-integrity-v95-20260727/);
    assert.equal(
    ...
    assert.match(core, /tools\.runtime\.js\?v=jarvis-tools-v7-20260728-grounded-image-reference-v105/);
