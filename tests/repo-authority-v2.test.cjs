...
test("brain delegates natural intent to the bounded semantic model planner", () => {
    ...
    assert.match(brain, /sia7-specialized-tool-scope-v91-20260726/);
    assert.equal(
    ...
    assert.match(core, /brain\.engine\.js\?v=sia7-specialized-tool-scope-v91-20260726/);
    assert.match(core, /jarvis\.mission\.orchestrator\.js\?v=sia7-compact-mission-storage-v83-20260725/);
    assert.match(core, /tools\.runtime\.js\?v=jarvis-tools-v7-20260726-specialized-tool-scope-v91/);
