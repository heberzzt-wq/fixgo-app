...
test("terminal has natural patchPreview follow-up memory gate before core planner", () => {
    ...
    assert.match(terminal, /mixed-intent-v2-20260714-multifunction-planner-v2-parallel-delegation/);
    ...
    assert.match(terminal, /jarvis-tools-v7-20260714-final-parallel-research/);
